                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        @foreach($allData as $key => $supplier)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-success" title="edit" href="{{route('suppliers-edit',$supplier->id)}}"><i class="fa fa-edit"></i></a>
                                                    @if($count_supplier<1)
                                                    <a class="btn btn-sm btn-danger" id="delete" title="Delete" href="{{route('suppliers-delete',$supplier->id)}}"><i class="fa fa-trash"></i></a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
