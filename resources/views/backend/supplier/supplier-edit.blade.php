                    ...
                    <section class="col-lg-12 connectedSortable">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a class="btn btn-success btn-sm float-right" href="{{route('suppliers-view')}}"><i class="fa fa-plus-circle"></i>Supplier List</a>
                                ...
                                <form method="post" action="{{route('suppliers-update',$editData->id)}}" id="myForm" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="name" id="datepicker" value="{{$editData->name}}" class="form-control">
                                        </div>
                                        <div class="form-group col-md-6">
