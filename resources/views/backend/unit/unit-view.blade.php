...
{{--                                                <td>{{$customer->address}}</td>--}}
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-success" title="edit" href="{{route('unites-edit',$unit->id)}}"><i class="fa fa-edit"></i></a>
                                                    @if($count_unit<1)
                                                    <a class="btn btn-sm btn-danger" id="delete" title="edit" href="{{route('unites-delete',$unit->id)}}"><i class="fa fa-trash"></i></a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
